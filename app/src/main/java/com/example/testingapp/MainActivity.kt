...
class MainActivity : AppCompatActivity() {
    ...
    private fun setTexts() {
        setText(R.id.gConst, R.id.gConstExp, gConst.toString())
        setText(R.id.vel, R.id.velExp, satelVel.toString())
        setText(R.id.planetMass, R.id.planetMassExp, planetMass.toString())
        setText(R.id.satelMass, R.id.satelMassExp, satelMass.toString())
        setText(R.id.centerDist, R.id.centerDistExp, centerDist.toString())
        setText(R.id.angularVel, R.id.angularVelExp, angularVel.toString())
        setText(R.id.linearMoment, R.id.linearMomentExp, linearMoment.toString())
        setText(R.id.freq, R.id.freqExp, freq.toString())
        setText(R.id.period, R.id.periodExp, period.toString())
        setText(R.id.forceMoment, R.id.forceMomentExp, forceMoment.toString())
        setText(R.id.cineticEnergy, R.id.cineticEnergyExp, cineticEnergy.toString())
        setText(R.id.potentialEnergy, R.id.potentialEnergyExp, potentialEnergy.toString())
        setText(R.id.mechanicalEnergy, R.id.mechanicalEnergyExp, mechanicEnergy.toString())
        setText(R.id.g0, R.id.g0Exp, g0.toString())
        setText(R.id.planetRadio, R.id.planetRadioExp, planetRadio.toString())
        setText(R.id.angularMoment, R.id.angularMomentExp, angularMoment.toString())
    }
    private fun setText(id:Int, idExp:Int, value:String){
        var num:scienceNotationNumber = scienceNotationNumber(number = 0.0, exponential = 0)
        if(value.contains('E')) {
        ...
        findViewById<EditText>(id).setText(num.number.toString())
        findViewById<EditText>(idExp).setText(num.exponential.toString())
    }
    private fun getScienceNotation(num:Double):scienceNotationNumber {
        var n = num
        var e = 0
        if(num < 10 && num >= 0){
            n = 0.0
    ...
    private data class scienceNotationNumber (
        var number: Double,
        var exponential: Int
    )
