...
class CircularOrbit : AppCompatActivity() {
    ...
    private fun setTexts() {
        setFields(findViewById(R.id.inputGConst), findViewById(R.id.gConstExp), gConst.toString())
        setFields(findViewById(R.id.vel), findViewById(R.id.velExp), satelVel.toString())
        setFields(findViewById(R.id.planetMass), findViewById(R.id.planetMassExp), planetMass.toString())
        setFields(findViewById(R.id.satelMass), findViewById(R.id.satelMassExp), satelMass.toString())
        setFields(findViewById(R.id.centerDist), findViewById(R.id.centerDistExp), centerDist.toString())
        setFields(findViewById(R.id.angularVel), findViewById(R.id.angularVelExp), angularVel.toString())
        setFields(findViewById(R.id.linearMoment),findViewById(R.id.linearMomentExp), linearMoment.toString())
        setFields(findViewById(R.id.freq), findViewById(R.id.freqExp), freq.toString())
        setFields(findViewById(R.id.period), findViewById(R.id.periodExp), period.toString())
        setFields(findViewById(R.id.forceMoment), findViewById(R.id.forceMomentExp), forceMoment.toString())
        setFields(findViewById(R.id.cineticEnergy), findViewById(R.id.cineticEnergyExp), cineticEnergy.toString())
        setFields(findViewById(R.id.potentialEnergy), findViewById(R.id.potentialEnergyExp), potentialEnergy.toString())
        setFields(findViewById(R.id.mechanicalEnergy), findViewById(R.id.mechanicalEnergyExp), mechanicEnergy.toString())
        setFields(findViewById(R.id.g0), findViewById(R.id.g0Exp), g0.toString())
        setFields(findViewById(R.id.planetRadio), findViewById(R.id.planetRadioExp), planetRadio.toString())
        setFields(findViewById(R.id.angularMoment), findViewById(R.id.angularMomentExp), angularMoment.toString())
    }
