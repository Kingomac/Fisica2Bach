...
class CircularOrbit : AppCompatActivity() {
    ...
    private fun setTexts() {
        setField(findViewById(R.id.inputGConst), findViewById(R.id.gConstExp), gConst.toString())
        setField(findViewById(R.id.vel), findViewById(R.id.velExp), satelVel.toString())
        setField(findViewById(R.id.planetMass), findViewById(R.id.planetMassExp), planetMass.toString())
        setField(findViewById(R.id.satelMass), findViewById(R.id.satelMassExp), satelMass.toString())
        setField(findViewById(R.id.centerDist), findViewById(R.id.centerDistExp), centerDist.toString())
        setField(findViewById(R.id.angularVel), findViewById(R.id.angularVelExp), angularVel.toString())
        setField(findViewById(R.id.linearMoment),findViewById(R.id.linearMomentExp), linearMoment.toString())
        setField(findViewById(R.id.freq), findViewById(R.id.freqExp), freq.toString())
        setField(findViewById(R.id.period), findViewById(R.id.periodExp), period.toString())
        setField(findViewById(R.id.forceMoment), findViewById(R.id.forceMomentExp), forceMoment.toString())
        setField(findViewById(R.id.cineticEnergy), findViewById(R.id.cineticEnergyExp), cineticEnergy.toString())
        setField(findViewById(R.id.potentialEnergy), findViewById(R.id.potentialEnergyExp), potentialEnergy.toString())
        setField(findViewById(R.id.mechanicalEnergy), findViewById(R.id.mechanicalEnergyExp), mechanicEnergy.toString())
        setField(findViewById(R.id.g0), findViewById(R.id.g0Exp), g0.toString())
        setField(findViewById(R.id.planetRadio), findViewById(R.id.planetRadioExp), planetRadio.toString())
        setField(findViewById(R.id.angularMoment), findViewById(R.id.angularMomentExp), angularMoment.toString())
    }
